const Donations = () => {
  return (
    <section className='font-gelion bg-light-purple pt-[82px] pb-[59px] relative overflow-hidden  '>
      ...
      <div className='absolute md:-bottom-2 bottom-4 right-5 w-24 h-24 md:w-40 md:h-40'>
        <div className='border-2 absolute top-0 left-0 w-24 h-24 md:w-40 md:h-40 border-primary border-dashed rounded-full animate-spin-slow'></div>
          <div className='bg-primary rounded-full w-16 md:w-32 h-16 md:h-32 mx-auto my-4 '>
          
              <img
                className='w-16 md:w-32 h-16 md:h-32'
                src='/public/assets/wink-boy.svg'
                alt=''
              />
