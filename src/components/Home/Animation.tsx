...
const AnimatedBoxes: React.FC = () => {
  ...
  return (
    <div className="flex gap-x-[14px] cursor-cell gap-y-2 max-md:px-7 relative sm:absolute max-md:-bottom-12 max-md:mt-0 sm:-right-[40px] sm:h-[524px] lg:h-[454px] max-md:flex-col xl:h-[574px] xl:-right-[102px] wideScreen:-right-[52px] xl:top-[90px] max-xl:mt-14 items-center">
      <div
