...
const Hero = () => {
  return (
    <section className="bg-gradient-to-b from-[#F8F8FD] to-white h-100vh">
      <div className="bg-[url('/assets/Hero-bg.svg')] bg-no-repeat bg-right bg-contain">
        <div className="pt-[251px] flex items-center overflow-hidden relative max-w-[1500px] mx-auto">
          <div className="px-7 sm:px-16 lg:px-[65px] md:py-0 xl:pl-[101px] relative ">
            <Bounce cascade damping={0.4} duration={2000}>
              ...
              <p className="max-w-2xl mb-8 text-lg font-dm-sans md:text-2xl text-grey">
                ...
                Nigeria in one place to share opportunities, work on awesome
                projects and foster quality connections.
              </p>
