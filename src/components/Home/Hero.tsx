          ...
          <div className="pt-[136px] max-w-[1500px] mx-auto">
            <div className="px-7 sm:px-16 lg:px-[65px] md:py-0 xl:pl-[101px] relative ">
              <Bounce cascade damping={0.4} duration={2000}>
                ...
                We are increasing the human capital resources of Africa and the earning power of Africans by connecting teens to opportunities in terms of jobs, mentorship, tech skills, and community interaction.
                </p>
