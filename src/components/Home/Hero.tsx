...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-b from-[#F8F8FD] h-full to-white md:min-h-[calc(100vh+100px)] lg:min-h-[calc(100vh+260px)] xl:min-h-[calc(100vh+100px)] overflow-hidden">
