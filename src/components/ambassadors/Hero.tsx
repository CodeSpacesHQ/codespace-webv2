...
export const Hero = () => {
  ...
  return (
    <>
      ...
      <div className="relative w-full h-full overflow-hidden mx-auto bg-primary bg-no-repeat bg-left bg-cover">
        ...
        <div className="xl:ps-[102px] pt-[136px] max-w-[1500px] mx-auto max-xl:px-[65px] pb-[129px] max-md:pb-[42px] flex justify-between items-center max-lg:items-end wideScreen:pe-[280px] xl:pe-[175px] max-md:px-7 max-lg:flex-col sm:px-16 lg:px-[65px]">
          ...
          >
            <p className="font-gelion text-[20px]/6 text-white font-normal tracking-[0.08em] mb-2 max-sm:text-[16px]/[19px] ps-[2px]">
              OUR AMBASSADORS
            </p>
            <h1 className="font-gelion max-lg:text-[45px] text-[55px]/[66px] max-md:text-[32px]/10 text-light-purple tracking-[-0.02em] font-semibold mb-[26px]">
              Let's build the next gen of visionary leaders 
            </h1>
          </motion.div>
          <motion.div
            {...slideAnimation("up")}
          ...
          >
            <div className="w-24 h-24 border-2 border-dashed rounded-full md:w-32 md:h-32 border-white animate-spin-slow"></div>
