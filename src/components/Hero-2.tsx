...
const JobHero: React.FC<JobHeroProps> = ({
  ...
  return (
    <>
      <div className="absolute top-0 left-0 w-full bg-[#f9f9f9] bg-cover h-20 sm:h-28"></div>
      <div
      ...
      >
        ...
        <div
          className={`xl:ps-[102px] pt-[136px] max-w-[1500px] mx-auto max-xl:px-[65px] pb-[129px] max-md:pb-[42px] flex justify-between items-center wideScreen:pe-[280px] xl:pe-[175px] max-md:px-7 max-lg:flex-col max-lg:items-end`}
        >
          <motion.div
            ref={ref}
